 ...
 */
final class Version20220415080909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE taches ADD user_id INT NOT NULL, ADD priorite_id INT NOT NULL, ADD description VARCHAR(255) NOT NULL, ADD date VARCHAR(255) NOT NULL');
